...
const ModuleCard: React.FC<ModuleCardProps> = ({ module, onClick, index, onOpenLinks }) => {
  ...
  return (
    <motion.div
      ...
      className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 cursor-pointer flex flex-col h-full relative overflow-hidden group"
      onClick={onClick}
    >
      {/* Decoration Circle */}
      ...
      <div className="mb-4">
        <div className={`inline-flex p-3 rounded-lg bg-slate-50 ${module.color}`}>
      ...
      <div className="flex items-center justify-between mt-auto">
        ...
        <div className="flex items-center text-sm font-medium text-slate-900 group-hover:text-blue-600 transition-colors">
          ...
          <ArrowRight className="w-4 h-4 ml-2 text-orange-500 opacity-0 group-hover:opacity-100 transition-opacity" />
        </div>
